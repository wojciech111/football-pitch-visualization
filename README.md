...
* to run simulations
  * iOS - start program "Simulator" than in terminal "i"
  * android - start program "Android studio" than in any project Tools -> AVD Manager and play. than in terminal "a"
* ES Lint
  * yarn run lint - to check linting
  * yarn run lint:fix - to fix what can be fixed
* code format - it is run everytime  you do 'git add' so before commit (thanks to husky)
  * yarn run format-code - to use prettier and than lint:fix
* project structure - https://learn.handlebarlabs.com/courses/253279/lectures/3939771
...
If you're not able to load the `http` URL in your phone's web browser, try using the tethering/mobile hotspot feature on your phone (beware of playersPositions usage, though), connecting your computer to that WiFi network, and restarting the packager. If you are using a VPN you may need to disable it.
